        ...
        <div className="space-y-4">
          ...
          {showComments && (
            <div className="space-y-4 pt-4 border-t">
              <div className="space-y-4">
                {/* DISPLAY COMMENTS */}
                {post.comments.map((comment: { id: string, content: string, createdAt:string , author: { id: string, name: string, username: string, image: string | null } }) => (
